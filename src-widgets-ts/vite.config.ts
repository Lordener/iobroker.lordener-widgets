...
const config = {
    plugins: [
        federation({
            manifest: true,
            name: 'lordenerWidgets',
            filename: 'customWidgets.js',
            exposes: {
                './HeizungWidget': './src/HeizungWidget', // List of all widgets in this package
                './AlarmWidget': './src/AlarmWidget',
                './RolloWidget': './src/RolloWidget',
                './FensterWidget': './src/FensterWidget',
